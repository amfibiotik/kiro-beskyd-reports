...
echo "============================"
echo ""
echo "This will install /save-session, /weekly-report and /monthly-report skills."
...
mkdir -p "$KIRO_DIR/skills/monthly-report"
...
cp "$SCRIPT_DIR/skills/monthly-report/SKILL.md" "$KIRO_DIR/skills/monthly-report/SKILL.md"
...
echo "  $KIRO_DIR/skills/monthly-report/SKILL.md"
